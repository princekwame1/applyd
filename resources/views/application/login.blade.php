...
<section class="page-hero">
    <div class="container center">
        ...
        <h1 class="section-title">Continue your application</h1>
        <p class="section-lead">Sign in with the Serial Number and PIN sent to your phone after payment.</p>
    </div>
</section>
        ...
        <div class="form-card" style="max-width:460px;">
            ...
            <form method="POST" action="{{ route('application.login.attempt') }}" class="enroll-form">
                ...
                <div>
                    ...
                    <input type="text" id="serial_no" name="serial_no" value="{{ old('serial_no') }}" placeholder="e.g. UG2645561" required autofocus>
                </div>
                <div>
            ...
            <p style="text-align:center; color:var(--ink-soft); font-size:.85rem; margin-top:16px;">
                Haven't registered yet? <a href="{{ route('courses') }}" class="tool-link">Browse courses</a>
            </p>
        </div>
    </div>
</section>
