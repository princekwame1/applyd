...
<body class="admin-body">
    <aside class="admin-sidebar">
        ...
        <nav class="side-nav">
            ...
            <div class="side-group {{ request()->routeIs('dashboard.registrations', 'dashboard.show', 'dashboard.schedules*', 'dashboard.tools*', 'dashboard.videos*', 'dashboard.surveys*') ? 'open' : '' }}" data-side-group>
                ...
                <div class="side-group-items">
                    ...
                    <a href="{{ route('dashboard.videos') }}" class="{{ request()->routeIs('dashboard.videos*') ? 'active' : '' }}"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="5" width="14" height="14" rx="2"/><polygon points="16 11 22 7 22 17 16 13"/><polygon points="7 9 11 12 7 15"/></svg> Session Videos</a>
            ...
            <div class="side-group {{ request()->routeIs('dashboard.courses*', 'dashboard.course-registrations', 'dashboard.facilitators*') ? 'open' : '' }}" data-side-group>
                ...
                <div class="side-group-items">
                    ...
                    <a href="{{ route('dashboard.facilitators') }}" class="{{ request()->routeIs('dashboard.facilitators*') ? 'active' : '' }}"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 11h-6"/><path d="M19 8v6"/></svg> Facilitators</a>
                </div>
            </div>
            ...
            <div class="side-group {{ request()->routeIs('dashboard.cms*') ? 'open' : '' }}" data-side-group>
                <button type="button" class="side-group-toggle" data-side-toggle><span>Website (CMS)</span>{!! $caret !!}</button>
                <div class="side-group-items">
                    <a href="{{ route('dashboard.cms') }}" class="{{ request()->routeIs('dashboard.cms*') ? 'active' : '' }}"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><line x1="3" y1="9" x2="21" y2="9"/><line x1="9" y1="21" x2="9" y2="9"/></svg> Pages</a>
                </div>
            </div>

            <div class="side-group {{ request()->routeIs('dashboard.sms-logs*', 'dashboard.blog*', 'dashboard.email-templates*', 'dashboard.email-logs*', 'dashboard.questionnaires*') ? 'open' : '' }}" data-side-group>
                <button type="button" class="side-group-toggle" data-side-toggle><span>General</span>{!! $caret !!}</button>
                <div class="side-group-items">
                    <a href="{{ route('dashboard.questionnaires') }}" class="{{ request()->routeIs('dashboard.questionnaires*') ? 'active' : '' }}"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M9 2h6a1 1 0 0 1 1 1v1H8V3a1 1 0 0 1 1-1z"/><path d="M16 4h2a2 2 0 0 1 2 2v13a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><polyline points="8 11 9.5 12.5 12 10"/><polyline points="8 16 9.5 17.5 12 15"/><line x1="14" y1="11.5" x2="17" y2="11.5"/><line x1="14" y1="16.5" x2="17" y2="16.5"/></svg> Questionnaires</a>
    ...
    <script>
        ...
        $(function () {
            $('select').filter(function () {
                return !this.closest('[wire\\:id]') && !this.hasAttribute('data-no-select2') && !this.closest('.ql-toolbar');
            }).select2({ width: '100%' });
        });
    </script>
    <script>
