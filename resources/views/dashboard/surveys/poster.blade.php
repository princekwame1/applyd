...
<head>
    ...
    <title>{{ $copy['label'] }} — Scan to check in</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .qr { display: inline-block; padding: 18px; border: 2px solid var(--ink); border-radius: 16px; }
...
<body>
    <div class="sheet">
        ...
        <div class="eyebrow">{{ $copy['eyebrow'] }} · Pulse Check</div>
        <h1>{{ $copy['label'] }}</h1>
        <p class="lead">{{ $copy['blurb'] }} Point your camera at the code.</p>
        ...
        <div class="bar">
            ...
            <a href="{{ route('dashboard.surveys', ['survey' => $survey]) }}">Back to results</a>
        </div>
    </div>
