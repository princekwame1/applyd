...
<form method="POST"
    ...
    <div class="modal-grid">
        ...
        <div>
            <label class="field-label" for="c_price">Price (GHS)</label>
        ...
        <div>
            ...
            <div class="file-field">
                ...
                <input type="file" id="c_image" name="image" accept="image/png,image/jpeg,image/webp" data-preview="c_image" hidden>
        ...
        <div class="span-2">
            ...
            <textarea id="c_description" name="description" rows="3" style="width:100%; padding:10px 14px; border:1.5px solid #cbd5e1; font-size:1rem; font-family:inherit;">{{ old('description', $model?->description) }}</textarea>
